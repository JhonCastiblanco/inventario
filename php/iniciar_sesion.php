...
if ($check_user->rowCount() == 1) {
    ...
    if ($check_user['usuario_usuario'] == $usuario && password_verify($clave, $check_user['usuario_clave'])) {
        ...
        switch ($rol_id) {
            case 1:
                $url = 'index.php?vista=home';
                break;
            case 2:
                $url = 'index.php?vista=operador_inventario/index_op_inventario';
                break;
            case 3:
                $url = 'index.php?vista=operador/index_operador';
                break;
            default:
                $url = 'index.php?vista=error'; // Puedes ajustar esto a una vista predeterminada o de error
                break;
        }
