    ...
    <form action="./php/producto_actualizar.php" method="POST" class="FormularioAjax" autocomplete="off" enctype="multipart/form-data">
        ...
        <div class="columns">
            ...
            <div class="column">
                <div class="control">
                    <label>Marca</label>
                    <input class="input" type="text" name="producto_marca" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,$#\-\/ ]{1,70}" maxlength="70" value="<?php echo $datos['producto_marca']; ?>" required>
                </div>
            </div>
        </div>
        ...
        <div class="columns">
            <div class="column">
                <div class="control">
                    ...
                    <input class="input" type="text" name="producto_descripcion" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,$#\-\/ ]{1,250}" maxlength="250" value="<?php echo $datos['producto_descripcion']; ?>" required>
                </div>
            </div>
        </div>
        ...
        <div class="columns">
            <div class="column">
                <div class="control">
                    <label>Imagen</label>
                    <input type="file" name="producto_foto" accept="image/*">
                </div>
            </div>
        </div>
